    ...
    <div class="page-wrapper">
      ...
      <div class="content-wrapper">
        <div class="content">
          ...
          <?php
          if (isset($_POST['add_Food Items'])) {

            $id = autoid("tbl_nutrition", "baby_id");
            $user_id = $_POST['user_id'];
            $a_date = $_POST['a_date'];
            $daily_activites = $_POST['nutrition'];
            ...
            $query = "INSERT INTO tbl_nutrition(`userid`,`date`,`actvty`,`img`) VALUES('$user_id','$a_date','$daily_activites','$target_file')";
            ...
            <div class="col-lg-6">
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="card card-default">
                  ...
                  <div class="col-sm-12">
                    <label class="text-dark font-weight-medium" for="">Daily Activites</label>
                    <div class="input-group mb-2">
                      ...
                      <select class="form-control" id="activites" name="activites" required>
                        ...
                        <option value="role_play">Dress-Up and Role Play</option>

                        <option value="run">Running and Jumping</option>

                        <option value="cook"> Cooking and Pretend-Cooking</option>
                  ...
                  <div class="col-sm-12">
                    ...
                    <input type="file" name="activity_img" class="form-control mb-3" required>
                  </div>




                  <button class="my-1 btn btn-sm btn-success mt-1" name="add_activites" type="submit">Add
                    Activity</button>
                ...
                <div class="card-body pt-0" data-simplebar="" style="height:100%;">
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        <?php
                        $query_run = mysql_query("SELECT a.*,b.baby_name FROM tbl_activites a JOIN tbl_registration b ON a.userid = b.baby_id");
