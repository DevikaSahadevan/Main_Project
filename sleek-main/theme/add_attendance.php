              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                <li class="has-sub active expand">
                  ...
                  <ul class="collapse " id="app" data-parent="#sidebar-menu">
                    <div class="sub-menu">
                      <li class="">
                        <a class="sidenav-item-link" href="add_attendance.php">
          ...
          <div class="content-wrapper">
            <div class="content">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-8 col-sm-8"><h1>Add Attendence</h1>
                      <table>
                <tr>
            ...
            while($row= mysql_fetch_array($baby_res))
            {
                ?> 
                    <tr>
                        ...
                        $sq=mysql_query("SELECT * from tbl_attendence where baby='$bid' and att_date='$date'");
                        
                         while($rows= mysql_fetch_array($sq))
                       {
                        
                        echo $count="SELECT count(baby) from tbl_attendence where baby='$bid' and att_date='$date'";
                        if($count==0)
                        {
                        ?>
                        <a href="activate.php?bid=<?php echo $row['baby_id'];?>"><button type="submit" class='btn btn-primary' name="present">Present</button></a>&nbsp
                        <?php
                        }
                        else{
                           echo $rows['att'];
...
<div class="row">
            ...
            $baby_res= mysql_query("SELECT * from tbl_attendence join tbl_registration where tbl_registration.baby_id=tbl_attendence.baby");
