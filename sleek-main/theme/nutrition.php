	...
	<div class="col-lg-6">
       ...
       <form action="" method="POST" enctype="multipart/form-data">
		<div class="card card-default">
			...
			<div class="col-sm-12">
				<label class="text-dark font-weight-medium" for="">Enter Description</label>
				<div class="input-group mb-2">

					<textarea class="form-control" name="name" placeholder="Enter Nutrition Description" 
					required></textarea>
				</div>
			</div>
...
if(isset($_POST['submit']))
{
	...
	//$date=date("y-m-d");
				...
				$target_dir = "../../nutrition/";     //saving folder
				$target_file=$id."_.jpg";           //filename
				move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],$target_dir.$target_file);    //uploading
				$file="nutrition/".$target_file;      //dbfield info
			
            $sql="INSERT INTO `tbl_nutrition` VALUES ('$id','$name','$file','1')";
            if(mysql_query($sql,$con))
            {
                    echo"<script>alert('Nutrition Added');</script>";
            }
			else{
			...
			<div class="col-xl-10">
                  ...
                  <div class="card card-table-border-none">
                    ...
                    <div class="card-body pt-0" data-simplebar style="height:100%;">
                      <table class="table ">
                        <tbody>
						<tr><th>Nutrition_Id</th><th>Details</th><th>Image</th><th>Action</th></tr>
						<?php
...
?>
						  ...
						  <td ><?php echo $row['n_id'];?></td>
                            ...
                            <td>
							<img src="../../<?php echo $row['n_image'];?>" width="30%"></td> <td class="text-dark d-none d-md-block"><a href=delnutrition.php?id=<?php echo $row['n_id'];?> >Delete</a></td>
                          </tr>
                         <?php
			  }
?> 
