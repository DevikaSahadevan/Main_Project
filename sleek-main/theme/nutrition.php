                ...
                <div class="card card-default">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <textarea class="form-control" name="name" placeholder="Enter Nutrition Description" required></textarea>
                    </div>
                  </div>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <img src="../../<?php echo $row['n_image']; ?>" width="30%">
                          </td>
                          <td class="text-dark d-none d-md-block"><a href=delnutrition.php?id=<?php echo $row['n_id']; ?>>Delete</a></td>
                        </tr>
                      <?php
                      }
                      ?>
