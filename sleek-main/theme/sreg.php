            ...
            if (isset($_POST['submit'])) {
              ...
              if ($flag == 0) {
                ...
                if ($flag == 1) {
                  ...
                  $sql = "INSERT INTO `tbl_sitterreg` VALUES ('$id','$name','$phno','$ano','$mailid','$dob','$file','$gender','$experience','$category','$hname','$sname','$zipcode','$city','$file2','1','$skill1','$skill2','$skill3','$skill4','$skill5','deactive')";
                //   mysql_query($sql, $con);
