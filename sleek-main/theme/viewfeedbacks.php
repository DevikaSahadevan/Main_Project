			...
			<div class="col-xl-10">
                  ...
                  <div class="card card-table-border-none">
                    ...
                    <div class="card-body pt-0" data-simplebar style="height: 468px;">
                      <table class="table ">
                        <tbody>
						<tr><th>Feedback_Id</th><th>User</th><th>Feedback</t<th>Date</th></tr>
						<?php
...
?>
						  ...
						  <td ><?php echo $row['f_id'];?></td>
                            ...
                            <td class="text-dark d-none d-md-block"><?php echo $row['f_name'];?></td>
							<td ><?php echo $row['feedback'];?></td><td ><?php echo $row['fdate'];?></td>
