            ...
            <div class="content-wrapper">
                <div class="content">
                    ...
                    if (isset($_POST['edit_food'])) {
                        ...
                        $listfood = mysql_query("SELECT * FROM tbl_fooditems WHERE f_id = '$edit_food'");
                        $fooditem = mysql_fetch_assoc($listfood);
                    }
                    ...
                    if (isset($_POST['edit_submit'])) {
                        ...
                        $editquery = mysql_query("UPDATE tbl_fooditems SET f_breakfast = '$breakfood', f_lunch = '$lunchfood', f_evngsnack = '$evngfood' WHERE f_id = '$edit_submit'");
                        if ($editquery) {
                            ...
                            <form action="" method="POST">
                                <div class="card card-default">
                                    <div class="card-header card-header-border-bottom">
                                        <h2>Edit FoodItems</h2>
                                    </div>
                                    <div class="col-sm-12">
                                        <label class="text-dark font-weight-medium" for="">Date</label>
                                        <select class="form-control" id="breakfast" name="day" required disabled>
                                            <option value="<?php echo $fooditem['day'] ?>" selected disabled><?php echo $fooditem['day'] ?></option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <select class="form-control" id="breakfast" name="breakfood" required>
                                                ...
                                                <option value="Waffles and Fresh Fruits">Waffles and Fresh Fruits
                                                </option>
                                                <option value="Scrambled eggs and turkey sausage">Scrambled eggs and
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <select class="form-control" id="activites" name="evngfood" required>
                                                ...
                                                <option value="Milk and Bread with butter">Milk and Bread with butter
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <button class="my-1 btn btn-sm btn-success mt-1" name="edit_submit"
                                        value="<?php echo $fooditem['f_id'] ?>" type="submit">Edit
                                        Food</button>
                                </div>
                            </form>
                        </div>
