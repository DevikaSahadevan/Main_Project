                            ...
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="row g-3">
										...
										<div class="col-sm-12">
                                            <div class="form-floating">
                                                <textarea class="form-control border-0" id="msg" name="msg" placeholder="Enter Feedback" 
												 required> </textarea>
                                                <label for="subject">Enter Feedback</label>
                                            </div>
                                        </div>
                            ...
                            if(isset($_POST['submit']))
							 {
								...
								$id=autoid("tbl_feedback","f_id");
								 ...
								 $sql="INSERT INTO tbl_feedback values('$id','$uname','$_POST[msg]','$date')";
								 echo"$sql";
								 $result=mysql_query($sql,$con);
								if($result)
								{
									echo "<script>alert('Feedback Added!');location.href='feedback.php';</script>";
								}
							 	else
								{
